...
真源是 settings.payload.knowledge_jobs.accounts[<account_id>]。
旧的顶层 capture_enabled / review_enabled 只当缺省。
"""
...
def _root() -> dict[str, Any]:
    from mino_nexus.services.settings_store import _root as settings_root
...
def _save(root: dict[str, Any]) -> None:
    from mino_nexus.services.settings_store import _save as settings_save
...
def resolve_app_account(
    *,
    ...
    from mino_nexus.services.project_store import find_test_account
