"""文件账号。形状对齐 Console / Studio 的 `/auth/*`，不搬上游 SecurityManager。"""
...
def _root() -> dict[str, Any]:
    ...
    raw.setdefault("codes", [])
    raw.setdefault("agent_sessions", {})
    return raw
...
def mail_configured() -> bool:
    from mino_nexus.settings_store import mail_ready
    return mail_ready()
...
def send_code(email: str, purpose: str = "register") -> dict[str, Any]:
    from mino_nexus.settings_store import send_mail
